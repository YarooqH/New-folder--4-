...
const CHARACTER_SPRITE_SHEET = './assets/MeowKnight/Meow-Knight_Run.png';
...
export class SpriteCharacterController {
    ...
    walkDirection = new THREE.Vector2();
    rotateWalkDirection = new THREE.Quaternion();
    rotateYAxis = new THREE.Vector2(0, 1);


    constructor(camera, orbitControls, scene) {
        this.camera = camera;
        this.orbitControls = orbitControls;

        this.spriteFlipbook = new SpriteFlipbook(CHARACTER_SPRITE_SHEET, 1, 10, scene);
